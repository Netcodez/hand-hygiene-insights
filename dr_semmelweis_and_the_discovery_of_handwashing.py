...
Original file is located at
    https://colab.research.google.com/drive/199I-ZYfUG1T3iFSWgZ159X6NNUngPlgP
...
ax = monthly['proportion_deaths'].plot(x='date', y='proportion_deaths', ylabel='Proportion deaths')
